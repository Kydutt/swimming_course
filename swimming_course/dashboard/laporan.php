...
//  Chart.js Data & Setup
// ═══════════════════════════════════════════════════════════════
const bulanLabels     = <?= $chart_bulan_labels ?>;
const bulanJumlah     = <?= $chart_bulan_jumlah ?>;
const bulanPendapatan = <?= $chart_bulan_pendapatan ?>;
const progLabels      = <?= $chart_prog_labels ?>;
const progJumlah      = <?= $chart_prog_jumlah ?>;
const progPendapatan  = <?= $chart_prog_pendapatan ?>;
